        ...
        Typeform = function() {
            ...
            return defaults = {
                ...
                return this.Loader.show(), this.resize(), _.defer(function() {
                    $("body").addClass("form-ready").trigger("form-ready"), hideInitialLoad.call(self), initializePiping.call(self), self.hasForm && initializeLogicJumps.call(self), showCurrentPage.call(self), afterHideLoader.call(self), Globals.isEmbed && Globals.embedOptions.embedIsWidget && parent.postMessage("form-ready", "*"), self.uiWebViewWorkaround()
                })
                ...
                if (this.updateFontClass(settings.font), $("body").removeClass("preload"), "preview" === this.settings.parent && (document.domain = "typeform.com"), $("input,textarea,select").each(function() {
...
UrlModelFactory = App.UrlModelFactory, Screen = function() {
    ...
    return Screen.prototype.id = null, Screen.prototype.isActive = !0, Screen.prototype.hasButton = !0, Screen.prototype.isDefaultBranded = !1, Screen.prototype.timeoutAttachment = null, defaults = {
        ...
        if (self = this, this.$screen.fadeOut(Globals.pageTransitionDelay, function() {
            ...
            }), this.unbindEvents()) return App.Tracking.startConversation()
...
Banner = function() {
        ...
        return Banner.$el = "", Banner.template = '<div id="banner" class="step<%=containerStep%> <%=className%>">\t\t<div class="overlay"></div>\t\t<div class="persistent background"></div>\t\t<div class="persistent"></div>\t\t<div class="content">\t\t\t<div class="button-wrapper by">\t\t\t\t<span><%=text%></span>\t\t\t\t<a href="<%=url%>" target="_blank" class="button general enabled">\t\t\t\t\t<%=buttonText%>\t\t\t\t</a>\t\t\t</div>\t\t</div>', Banner.params = {
            ...
            return /-ES|es|es-/.test(navigator.language) ? "es" : "en", params = {
                ...
                utm_source: "typeform.com-" + Globals.accountId + "-" + Globals.accountPlan,
    ...
    function() {
        ...
        var toMilliseconds = function(seconds) {
            ...
            submit = function(data) {
                var error = 0;
                /*if(data['textfield:password'] !== data['textfield:passwordConfirm']){
                   swal({
                        type: 'error',
                        title: 'Error',
                ...
                if(data['email:email'] !== data['email:emailConfirmacion']){
                   swal({
                        type: 'error',
                        title: 'Error',
              ...
              if(error == 0){
                  jQuery.ajax({
                        ...
                        url: 'APICall.php',
                        dataType: 'json',
                        data: {nombre: data['textfield:nombre'], apellido: data['textfield:apellido'], email: data['email:email'], password: data['textfield:password']},
                        success: function (obj, textstatus) {
                                    ...
                                    if(data.message != null){
                                        swal({
                                         ...
                                         //return $("body").addClass("footer-submit footer-warning"), $( "footer-message" ).find(".default-message").html(data.message);
                                    }
                                    else{
                                        return window.location.href = 'sucess.php';
...
var Textfield = function(elem, options) {
    ...
    function confirmEmailAdress() {
        var email = document.getElementById('email');
        var email2 = document.getElementById('confirm_email');
    ...
    var $input, $confirmButton, $span, $item, $spin, min, max, isEmailType,isEmailConfirmType, isPasswordConfirmType, isWebsiteType, isNumberType, prevVal, _this = this,
        showConfirm = !1,
        $result = elem.children(".result");
    this.value = "", this.pipeValue = "", this.isCompleted = !1, this.required = elem.hasClass("required"), this.unique = elem.hasClass("unique"), this.done = !1, this.required, isEmailType = elem.hasClass("email"),isEmailConfirmType = elem.hasClass("emailConfirm"),isPasswordConfirmType = elem.hasClass("passwordConfirm"), isWebsiteType = elem.hasClass("website"), isNumberType = elem.hasClass("number"), this.confirmText = "default", this.attachLimit = {
        "default": 180,
        large: 170,
        small: 155
        ...
        if (isEmailConfirmType && !confirmEmailAdress()) return showError && form.error.show(elem, 'Los correos no coinciden!'), Globals.useFocus && $input.focus(), !1;
        if (isPasswordConfirmType && !confirmPassword()) return showError && form.error.show(elem, 'Las contraseñas no coinciden!'), Globals.useFocus && $input.focus(), !1;
...
var Rating = function(elem) {
    ...
    function addIcons(steps) {
        ...
        $(steps).each(function(i, val) {
            "default" == Globals.browser && (label = "<div class='label fontFamily secondaryColor'><div class='letter'><span>" + val + "</span></div></div>", back = "<div class='icon back'></div>"), $icons.append("<li><div class='center-wrapper'><div class='center'><div class='icon'></div>" + back + label + "</div></div></li>")
        ...
        var StripeElement = function(elem, options) {
            ...
            var _toRGBA = function(color, opacity) {
                ...
                _fetchStylesFromForm = function() {
                    var $formInput = $('[id*="creditCardName"] input'),
                        style = {
                            base: {
                ...
                _forceBlurInput = function() {
                    _this.bluring = !0, stripeElement.blur(), $visuallyHiddenInput.focus(), $visuallyHiddenInput.blur()
                },
                ...
                _onTouchConfirmHandler = function(event) {
                    event.stopPropagation(), elem.toggleClass("filled", !_this.isEmpty()), _resetElementPosition(), setTimeout(function() {
                ...
                _onBlurTouchHandler = function() {
                    _this.preventScroll = !1, _forceBlurInput(), _resetElementPosition(), setTimeout(function() {
        ...
        var Tracking = function() {
            var isStartConversationSent = !1,
                ...
                trackAsCreator = function(eventData) {
                    ...
                    eventData.account_id = getAccountId(), eventData.userId = getUserId(), eventData.ws_owner_account_id = getWorkspaceOwnerId(), eventData.form_id = getFormId(), eventData.form_uid = getFormUid(), eventData.attribution_user_id = attributionUtil.getUser(), trackingClient.identify(parseInt(getUserId(), 10), null, {
                        integrations: {
                            Intercom: !1,
                            GoogleAnalytics: !1
                        }
                    }), setTimeout(function() {
                        trackingClient.sendEvent(eventData.event, eventData), clearTimeout(this.resetUserTimeout), this.resetUserTimeout = setTimeout(resetUser, 1e3)
                    }, 1e3)
                };
            return {
